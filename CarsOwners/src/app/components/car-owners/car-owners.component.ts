...
export class CarOwnersComponent implements OnInit {
  ...
  editOwner() {
    ...
    editownerModal.componentInstance.Info = 'Редактирование';
    editownerModal.componentInstance.Button = 'Сохранить';
  ...
  addNewOwner() {
    ...
    addupdateownerModal.componentInstance.Info = 'Добавление собственника';
    addupdateownerModal.componentInstance.Button = 'Добавить';
  ...
  deleteOwner() {
    ...
    asseptModal.componentInstance.actionName = `Удалить пользователя ${
  ...
  viewOwner() {
    ...
    viewovners.componentInstance.owner =
      this.databaseowners[this.selectedrowowner];
    viewovners.componentInstance.Info = 'Просмотр информации';
